...
!function(t){"use strict";function a(){t("[data-toggle]").tooltip()}function n(){t(".post-body p:first-child").addClass("lead");var a=t(".featured-image").find("img").attr("src");a&&(t(".post-header").css("backgroundImage","url("+a+")"),t("#footer").css("backgroundImage","url("+a+")"))}t(document).ready(function(){a(),n();var o=t(".navbar"),r=t(".content");r.waypoint(function(t){o.toggleClass("navbar-transparent")})})}(jQuery);
